...
class PlaneController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('panel.planes.create',
            compact('title', 'classes', 'brands'));
    }
    ...
    public function show($id)
    {
        ...
        return view('panel.planes.show',
            compact('plane', 'title', 'brand'));
    }
    ...
    public function edit($id)
    {
        ...
        $title = "Editar Avião: {$plane->brand->name}";

        return view('panel.planes.edit',
            compact('plane', 'title', 'classes', 'brands'));
    }
