...
class BrandController extends Controller
{
    ...
    public function search(Request $request)
    {
        ...
        $brands = $this
            ->brand
            ->search($request->key_search, $this->totalPage);

        $title = "Brands, filtro para: {$request->key_search}";

        return view('panel.brands.index',
            compact('title', 'brands', 'dataForm'));
    }
    ...
    public function planes($id)
    {
        ...
        return view('panel.brands.planes',
            compact('title', 'planes', 'brand'));
    }
}
